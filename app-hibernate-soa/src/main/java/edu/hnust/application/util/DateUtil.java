...
public class DateUtil {
    ...
    /**
     * 获取当前周的星期6的日期（一周的最后一天）
     * @return
     * @author  Henry(fba02)
     * @version  [版本号, 2017年11月11日]
     * @see [类、类#方法、类#成员]
     */
    public static String getLastDateByWeek() {
        Calendar cal = Calendar.getInstance();
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String getLastDateByWeek(int year, int week) {
        Calendar cal = Calendar.getInstance();
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String getFirstDateByWeek(int year, int week) {
        Calendar cal = Calendar.getInstance();
        cal.setWeekDate(year, week, 1);
        cal.set(Calendar.DAY_OF_WEEK, Calendar.SUNDAY);
        return new SimpleDateFormat(DateUtil.Format_Date).format(cal.getTime());
